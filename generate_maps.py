...
from automon.slack_formatting import Chat

MIBS_ = 'mibs'
requires = 'smidump'

WORK_dir, _ = os.path.split(__file__)
MIBS_dir = os.path.join(WORK_dir, MIBS_)

log = Logging('generate', level=Logging.ERROR)
...
class MIBS:
    def __init__(self, device: str = None):
        ...
        if device:
            ...
            self.devices = os.listdir(MIBS_dir)
        ...
        for device in self.devices:
            ...
            path_to_device_folder = os.path.join(MIBS_, device)
    ...
    def generate_prometheus_config(self) -> open:
        ...
        return prometheus_config.save_config(path=MIBS_)
